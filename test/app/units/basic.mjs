...
function test_app_basic() {
  ...
  test_app_base('basic', (fetcher) => {
    ...
    it(`[miolo-test-routes][basic] should set auth`, async function() {
      set_auth(fetcher, AUTH)
      assert.strictEqual(fetcher.auth.username, AUTH.username)
    })

    it(`[miolo-test-routes][basic] should insert fake todos`, async function() {
    ...
    it(`[miolo-test-routes][basic] should remove fake todos`, async function() {
      const res= await remove_todos(fetcher, fake_tids)

      assert.strictEqual(res.length, TODOS.length)
    })

    it(`[miolo-test-routes][basic] should insert fake single todo`, async function() {
    ...
    it(`[miolo-test-routes][basic] should remove fake single todo`, async function() {
