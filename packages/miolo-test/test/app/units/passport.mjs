...
import TODOS from "#data/todos.mjs"
import { test_miolo_app_start, test_miolo_app_stop } from "#server/index.mjs"
...
test("passport", async (t) => {
  ...
  await test_miolo_app_start("passport")
