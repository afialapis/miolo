const _ADMIN_PERMISSIONS = ["prop_see_all", "prop_remove", "guest_remove"]

const _DEV_PERMISSIONS = ["debug_data"]
...
class Permissioner {
  ...
  can_user_remove_prop() {
    return this.has_permission("prop_remove")
  }
  can_user_see_all() {
    return this.has_permission("prop_see_all")
  }
  can_user_remove_guest() {
    return this.has_permission("guest_remove")
  }
}
