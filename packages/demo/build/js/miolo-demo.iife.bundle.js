...
(function () {
	...
	*/
	...
	function RenderedRoute(_ref) {
	  ...
	  let dataRouterContext = reactExports.useContext(DataRouterContext); // Track how deep we got in our render pass to emulate SSR componentDidCatch
	...
	function Routes(_ref5) {
	  ...
	  let dataRouterContext = reactExports.useContext(DataRouterContext); // When in a DataRouterContext _without_ children, we use the router routes
	...
	var Header = function Header(_ref3) {
	  ...
	  })), /*#__PURE__*/React.createElement("div", null, "demo")), /*#__PURE__*/React.createElement("div", {
	    className: "toolbar"
	  }, /*#__PURE__*/React.createElement(ToolbarLink, {
	    name: "Todos",
	    path: "/todos"
	  }), context != null && context.authenticated ? /*#__PURE__*/React.createElement(ToolbarLink, {
	    name: "Logout",
	    path: "/logout"
	  }) : /*#__PURE__*/React.createElement(ToolbarLink, {
	    name: "Login",
	...
	var Page = function Page() {
	  ...
	  }, /*#__PURE__*/React.createElement(Badges, null), /*#__PURE__*/React.createElement("div", null, "miolo is sharpened by ", /*#__PURE__*/React.createElement("a", {
	    href: 'afialapis.com',
	    target: "_blank noopener noreferrer"
	  }, "afialapis.com"), " under ", /*#__PURE__*/React.createElement("a", {
	...
	var TodosList = function TodosList(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	  ...
	  }, /*#__PURE__*/React.createElement("h1", null, "To Do List"), /*#__PURE__*/React.createElement("div", {
	    className: "todos-add"
	  }, /*#__PURE__*/React.createElement("div", {
	    ...
	    return /*#__PURE__*/React.createElement("li", {
	      ...
	      className: "todo-text"
	    }, todo.name), authenticated ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
	      className: "todo-check " + (todo.done ? 'done' : 'undone'),
	      onClick: function onClick() {
	        return toggleTodo(todo.id);
	      }
	    }, todo.done ? /*#__PURE__*/React.createElement("svg", {
	  ...
	  }, /*#__PURE__*/React.createElement("h3", null, "Shortcuts"), /*#__PURE__*/React.createElement("div", {
	    className: "question",
	    onClick: function onClick() {
	      return checkLastHour();
	    }
	  }, "Tell me how many todos I have added in the last hour"), /*#__PURE__*/React.createElement("div", {
	    className: "question",
	    onClick: function onClick() {
	      return throwAnError();
	    }
	  }, "Throw some JS error (server will receive it)"), authenticated ? /*#__PURE__*/React.createElement("div", {
	    className: "question",
	    onClick: function onClick() {
	...
	var Todos = function Todos(_ref) {
	  ...
	  var addTodo = reactExports.useCallback(function (text) {
	    function addIt() {
	  ...
	  var toggleTodo = reactExports.useCallback(function (todoId) {
	    function toggleIt() {
	  ...
	  var removeTodo = reactExports.useCallback(function (todoId) {
	  ...
	  var checkLastHour = reactExports.useCallback( /*#__PURE__*/_asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
	    var res;
	    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
	      while (1) switch (_context3.prev = _context3.next) {
	        case 0:
	  ...
	  var insertFakeTodo = reactExports.useCallback( /*#__PURE__*/_asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
	    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
	      while (1) switch (_context4.prev = _context4.next) {
	        case 0:
	          _context4.next = 2;
	  ...
	  return /*#__PURE__*/React.createElement(TodosList, {
	...
	var LoginForm = function LoginForm(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	  ...
	  }, /*#__PURE__*/React.createElement("h5", null, "Username"), /*#__PURE__*/React.createElement("div", {
	    className: "input-container"
	  }, /*#__PURE__*/React.createElement("input", {
	    type: "text",
	    ...
	    className: "login-field-group"
	  }, /*#__PURE__*/React.createElement("h5", null, "Password"), /*#__PURE__*/React.createElement("div", {
	    className: "input-container"
	  }, /*#__PURE__*/React.createElement("input", {
	    type: "password",
	    value: password,
	  ...
	  }, "Login")), message != undefined ? /*#__PURE__*/React.createElement("div", {
	...
	var Login = function Login(_ref) {
	  ...
	  var _useState = reactExports.useState(undefined),
	    message = _useState[0],
	    setMessage = _useState[1];
	  var doTheLogin = reactExports.useCallback( /*#__PURE__*/function () {
	...
	var LogoutForm = function LogoutForm(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    ...
	    className: "goodbye"
	  }, "Farewell adi\xF3s my friend"), /*#__PURE__*/React.createElement("div", {
	...
	var Logout = function Logout() {
	  var fetcher = useFetcher();
	  var doTheLogout = reactExports.useCallback( /*#__PURE__*/_asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
	    return _regeneratorRuntime().wrap(function _callee$(_context) {
	      while (1) switch (_context.prev = _context.next) {
	        case 0:
	          _context.next = 2;
	...
	var Index = function Index(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement(Routes, null, /*#__PURE__*/React.createElement(Route, {
	    ...
	    index: true,
	    element: /*#__PURE__*/React.createElement(Todos$1, null)
	  }), /*#__PURE__*/React.createElement(Route, {
	    path: 'todos',
	    element: /*#__PURE__*/React.createElement(Todos$1, null)
	  }), context.authenticated ? /*#__PURE__*/React.createElement(Route, {
	    path: 'logout',
	    element: /*#__PURE__*/React.createElement(Logout, null)
	  }) : /*#__PURE__*/React.createElement(Route, {
	    path: 'login',
	...
	var App = function App() {
	  return /*#__PURE__*/React.createElement(AppBrowser, null, /*#__PURE__*/React.createElement(Index$1, null));
	};
